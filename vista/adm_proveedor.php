...
?>
<!-- modal de cambiar foto de proveedor -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cambiar logo de proveedor</h5>
...
<div class="modal fade" id="crearproveedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="alert alert-danger text-center" id="noadd-prov" style='display:none;'>
                ...
                <form id="form-crear">
                    ...
                    <div class="form-group">
                        ...
                        <input id="direccion" type="text" class="form-control" placeholder="Ingrese la direccion" required>
                    </div>
  ...
  <div class="content-wrapper">
    <!-- Contenido de formulario de crear prov -->
    ...
    <section>
        <div class="container-fluid">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <div id="proveedores" class="row d-flex aling-items-stretch">
