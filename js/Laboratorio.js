                ...
                template+=`
                    <tr labId="${laboratorio.id}" labNombre="${laboratorio.nombre}" labAvatar="${laboratorio.avatar}">>
                        ...
                        <td>
                            ...
                            <button class="editar btn btn-success" title="Editar nombre de laboratorio" type="button" data-toggle="modal" data-target="#crearlaboratorio">
                ...
                $.post('../controlador/LaboratorioController.php',{id,funcion},(response)=>{
                    ...
                    if(response=='borrado'){
                        ...
                        swalWithBootstrapButtons.fire(
                            ...
                            'El laboratorio '+nombre+' fue eliminado porque esta siendo usado en un producto.',
                            'error'
                        )
                    }
                })
